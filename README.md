...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/derivative-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10887&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/derivative-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `derivative` can be installed with:

```
conda install derivative
```

It is possible to list all of the versions of `derivative` available on your platform with:
